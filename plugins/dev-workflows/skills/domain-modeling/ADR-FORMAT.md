...
- **Constraints not visible in the code.** "We can't use AWS because of compliance requirements." "Response times must stay under 200ms because of the partner API contract."
